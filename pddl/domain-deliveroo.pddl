(define (domain deliveroo)
    ...
    (:action putdown
        ...
        :effect (and (parcel_at ?delivery_tile) (delivered_at ?delivery_tile) (not (carrying ?parcel))))
    (:action putdown_2
        :parameters (?delivery_tile)
        :precondition (and (is_carrying) (is_at ?delivery_tile) (not (parcel_at ?delivery_tile)))
        :effect (and (parcel_at ?delivery_tile) (delivered_at ?delivery_tile) (not (is_carrying))))
)